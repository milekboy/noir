...
import { FooterMenu, FooterStyleCode3, OurStores } from "@/constant/Alldata";
    ...
    <Fragment>
      <div className="page-wraper">
        ...
        <div className="page-content bg-light">
          <CommanBanner
            currentText="Footer Style 3"
            mainText="Footer Style 3"
            parentText="Home"
              ...
              <div className="col-md-4 col-lg-4 col-md-12 px-0">
                <div className="row dz-post g-0 spno">
                  ...
                  <Link href={"#"} className="instagram-link">
                    <div
                      className="follow-link bg-white wow bounceIn"
                      data-wow-delay="0.1s"
                    >
              ...
              <div className="col-md-8 col-lg-8 col-md-12">
                <div className="footer-top">
                  <div className="dz-custom-container">
                    <div
                      className="row align-items-center logo-topbar gx-0 wow fadeInUp"
                      data-wow-delay="0.1s"
                    >
                      <div className="col-12 col-sm-6">
                        <div className="footer-logo logo-white mb-0">
                          <Link href="/">
                            <Image src={IMAGES.LogoWhiteSvg} alt="" />
                          </Link>
                        </div>
                      </div>
                      <div className="col-12 col-sm-6">
                    ...
                    <div className="row">
                      <div
                        className="col-lg-4 col-md-4 col-sm-4 col-6 wow fadeInUp"
                        data-wow-delay="0.2s"
                      >
                      ...
                      >
                        ...
                        <div
                          className="col-lg-4 col-md-4 col-sm-4 col-12 wow fadeInUp"
                          data-wow-delay="0.4s"
                        >
                          <div className="widget widget_services">
                    ...
                    <div className="fb-inner">
                      <div className="text-center">
                        <p className="copyright-text">
                          ...
                          <Link href="https://www.dexignzone.com/">
                            {" "}
                            DexignZone
                          </Link>{" "}
