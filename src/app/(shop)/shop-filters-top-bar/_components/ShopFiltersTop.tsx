...
import { Modal, Collapse, Tab } from "react-bootstrap";
...
export default function ShopFiltersTop() {
  ...
  return (
    <div className="page-content bg-light">
      <CommanBanner
        currentText="Shop Filters Top"
        mainText="Shop Filters Top"
        parentText="Home"
            ...
            <div className="col-xl-12">
              <Tab.Container defaultActiveKey={"Grid"}>
                ...
                <div className="col-xl-12 shop-top-filter">
                  ...
                  <Collapse in={filterContent}>
                    <div
                      className={`shop-filter mt-xl-2 mt-0 ${
                        filterContent ? "d-block" : ""
                      }`}
                    >
                      <aside>
