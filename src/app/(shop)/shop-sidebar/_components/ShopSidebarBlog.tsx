...
export default function ShopSidebarBlog() {
  ...
  return (
    <div className="page-content bg-light">
      <CommanBanner
        mainText="Shop Sidebar"
        currentText="Shop Sidebar"
        parentText="Home"
                    ...
                    <Tab.Pane eventKey={"Coloumn"}>
                      <div className="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
                        {shopStyleData.slice(0, 8).map((item, ind) => (
                          <div
                            className="col-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30"
                            key={ind}
                          >
                            <ShopGridCard
                              image={item.image}
                    ...
                    <Tab.Pane eventKey={"Grid"}>
                      <div className="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
                        {shopStyleData.map((item, ind) => (
                          <div
                            className="col-6 col-xl-4 col-lg-4 col-md-4 col-sm-4 m-md-b15 m-sm-b0 m-b30"
                            key={ind}
                          >
                            <ShopGridCard
                              image={item.image}
