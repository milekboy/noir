...
const FeaturedBlog = () => {
  return (
    <div className="row">
      <div className="col-lg-12 left-box">
        ...
        >
          ...
          <Link href={"#"} className="animation-btn popup-youtube" style={{marginTop: "-310px", marginLeft: "600px"}}>
            <div
              className="text-row word-rotate-box c-black"
