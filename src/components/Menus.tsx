...
export default function Menus() {
  ...
  return (
    <ul className="nav navbar-nav">
              ...
              <ul>
                ...
                <li className="month-deal">
                  <div className="clearfix me-3">
                    ...
                    <p className="mb-0">
                      Yes! Send me exclusive offer, personalised, and unique
                      gift ideas, tips for shopping on Pixio{" "}
                      <Link href="/shop-standard" className="dz-link-2">
                        View All Products
                      </Link>
                    </p>
                  </div>
        ...
        <div className="mega-menu portfolio-menu">
          <ul>
            ...
            <li className="side-right line-left">
              ...
              <ul>
                <li>
                  <Link href="/portfolio-details-1">Portfolio Details 1</Link>
                </li>
                <li>
                  <Link href="/portfolio-details-2">Portfolio Details 2</Link>
                </li>
                <li>
                  <Link href="/portfolio-details-3">Portfolio Details 3</Link>
                </li>
                <li>
                  <Link href="/portfolio-details-4">Portfolio Details 4</Link>
                </li>
                <li>
                  <Link href="/portfolio-details-5">Portfolio Details 5</Link>
                </li>
              </ul>
            </li>
          </ul>
              ...
              <li key={ind}>
                {data.mainMenu &&
                  data.mainMenu.map((item, index) => (
                    <Fragment key={index}>
                      <Link href={item.link} className="menu-title">
                        {item.title}
                      </Link>
                      <ul>
                        {item.subMenu &&
                            ...
                            <Fragment key={i}>
                              ...
                              {elem.outerlink && (
                                <li className="w3menulink">
                                  <Link
                                    href="https://xmenu.indiankoder.com/react/"
                                    target="_blank"
                                  >
                                    Menu Styles
                                  </Link>
      ...
      >
        <Link href="#">
          <span>My Account</span> <i className="fas fa-chevron-down tabindex" />
        </Link>
